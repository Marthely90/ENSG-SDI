...
help:
	...
	@echo "  make build            # Builds all stacks"
...
up-apps: build
	...
	docker compose -f docker-compose.yml up -d --remove-orphans geoserver mapstore2 mviewer

#.PHONY: up-api
#up-api: build
#	@echo "[INFO] Bringing up the SDI API apps"
#	docker compose -f docker-compose.yml up -d --remove-orphans pygeoapi
